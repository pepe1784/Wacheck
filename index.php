...
<body>
    ...
    <div class="container">
        <div class="main-page" id="mainPage">
            ...
            <div class="action-buttons">
                <button class="play-btn primary" onclick="window.location.href='game-page.html'">
    ...
    <div class="game-container" id="gameContainer">
        <div class="game-header">
            <button class="game-back-btn" onclick="backToMain()">← Volver</button>
            ...
            if (playFromGamePage === 'true') {
                ...
                setTimeout(() => {
                    if (typeof window.startGameDirectly === 'function') {
                        ...
                        console.warn('startGameDirectly function no disponible');
                    }
                }, 1000);
            }
        });
